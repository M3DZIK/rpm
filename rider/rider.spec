...
%prep
%ifarch x86_64
wget -q https://download.jetbrains.com/rider/JetBrains.Rider-%{version}.tar.gz
tar xf JetBrains.Rider-%{version}.tar.gz
%else
wget -q https://download.jetbrains.com/rider/JetBrains.Rider-%{version}-aarch64.tar.gz
tar xf JetBrains.Rider-%{version}-aarch64.tar.gz
%endif

cd 'JetBrains Rider-%{version}'
...
%files
%license 'JetBrains Rider-%{version}'/license/*
%{_javadir}/%{name}
%{_bindir}/%{name}
