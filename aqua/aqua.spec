...
%prep
%ifarch x86_64
download_file="%{appname}-%{version}.tar.gz"
%else
download_file="%{appname}-%{version}-aarch64.tar.gz"
%endif
...
%changelog
* Fri Jan 24 2025 M3DZIK <me@medzik.dev> - 2024.3.2-1
- Update to 2024.3.2

* Fri Dec 20 2024 M3DZIK <me@medzik.dev> - 2024.3.1-1
- Update to 2024.3.1

* Wed Dec 11 2024 M3DZIK <me@medzik.dev> - 2024.3-1
- Update to 2024.3
