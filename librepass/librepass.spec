...
%global git_commit 93375b53aaaba6b1ae8762226551d355a2761333

Name:          librepass
Epoch:         2
Version: 1.0.0.alpha1.r112.g93375b5
Release: 1%{?dist}
...
cp -arf ./usr/lib/librepass/* %{buildroot}%{_datadir}/%{name}/
...
sed -i 's;/usr/lib/librepass;%{_datadir}/%{name};' %{buildroot}%{_bindir}/%{name}
...
%changelog
* Thu Sep 26 2024 M3DZIK <me@medzik.dev> - 2:1.0.0.alpha1.r112.g93375b5-1
- Update to 1.0.0.alpha1.r112.g93375b5

* Mon May 27 2024 M3DZIK <me@medzik.dev> - 1:1.0.0.alpha1.r111.g91745db-1
- Update to 1.0.0.alpha1.r111.g91745db

* Thu May 23 2024 M3DZIK <me@medzik.dev> - 1:1.0.0.alpha1.r109.g1e9f0fb-1
- Update to 1.0.0.alpha1.r109.g1e9f0fb

* Tue May 21 2024 M3DZIK <me@medzik.dev> - 1:1.0.0.alpha1.r108.g454086b-1
- Update to 1.0.0.alpha1.r108.g454086b

* Tue May 21 2024 M3DZIK <me@medzik.dev> - 1:1.0.0.alpha1.r107.g2c11640-1
- Update to 1.0.0.alpha1.r107.g2c11640

* Thu May 09 2024 M3DZIK <me@medzik.dev> - 1:1.0.0.alpha1.r104.g4843e39-1
- Update to 1.0.0.alpha1.r104.g4843e39
